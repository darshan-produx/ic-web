...
module.exports = plugin(function ({ addComponents, theme }) {
  addComponents({
    '[type="checkbox"]:checked': {
      '@apply bg-no-repeat': {},
      backgroundImage: `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'%3e%3cpath fill='none' stroke='%fff' strokeLinecap='round' strokeLinejoin='round' strokeWidth='3' d='m6 10 3 3 6-6'/%3e%3c/svg%3e")`,
      backgroundSize: '.9rem .9rem',
      backgroundPosition: '50%',
    },
    '[type="radio"]:checked': {
      '@apply bg-no-repeat': {},
      backgroundImage: `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3circle r='2' fill='%fff'/%3e%3c/svg%3e")`,
    ...
    '.form-select': {
      '@apply border rounded-md block  py-2 pl-3 pr-10 px-4 text-base w-full bg-no-repeat appearance-none':
        {},
      backgroundImage: `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%231f242e' strokeLinecap='round' strokeLinejoin='round' strokeWidth='2' d='m2 5 6 6 6-6'/%3e%3c/svg%3e")`,
